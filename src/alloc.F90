...
MODULE alloc
  ...
  use mpi,  Node=>taskid,  Nodes=>nprocs,  ionode=>master 
  use utils,     only: die       ! Termination routine
  use io_units,  only: IO_MEM_REPORT
